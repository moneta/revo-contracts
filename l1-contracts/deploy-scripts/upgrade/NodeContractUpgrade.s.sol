...
contract NodeContractUpgrade is Script, DeployL1Script {
    using stdToml for string;

    address constant bytecodeSupplier = 0xb74E5b0D76b369440613Eb3D5bcC52a9d0Cd6C83;
    ...
    function prepareEcosystemUpgrade() public virtual {
        SystemContracts.push("NodeContract");
        SystemAddresses.push(0x00000000000000000000000000000000000080FE);
